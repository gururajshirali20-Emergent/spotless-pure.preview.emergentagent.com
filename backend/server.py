...
PRODUCTS = [
    ...
    },
    {
        ...
        "highlights": ["Deep hygienic protection", "Enduring forest freshness", "Homes & professional spaces", "Premium concentrated formula"],
        "size": "1L",
        "group": "home-care",
    },
    {
        "id": "forest-aura",
        "name": "Forest Aura",
        "category": "Premium Hand Wash",
        "tagline": "Gentle Cleanse • Nourishing Care • Long Lasting Freshness",
        "accent": "#4E7C50",
        "description": "Forest Aura is a premium botanical hand wash that cleanses gently while nourishing the skin. Enriched with a soft forest fragrance, it leaves hands soft, refreshed and beautifully scented all day.",
        "highlights": ["Gentle daily cleansing", "Nourishing & pH balanced", "Botanical forest fragrance", "Kind to soft & sensitive skin"],
        "size": "250ml",
        "group": "home-care",
        "image_url": "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?w=1000&q=75",
    },
]
